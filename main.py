...
Correctness (Accuracy of facts, grammatical precision, logical coherence)
...
Correctness: [Feedback + Score (1-5)]

Depth of Knowledge: [Feedback + Score (1-5)]

Personability: [Feedback + Score (1-5)]
